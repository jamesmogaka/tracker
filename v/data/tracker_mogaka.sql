...
--
-- Host: localhost
-- Generation Time: Feb 12, 2024 at 04:00 PM
...
(22, 'Karen Nandi', 'Karen', 'KN', 'Tuesday', '2024-02-05', '2025-02-01', NULL, 'I.T', NULL, 'JKUAT', NULL);
...
CREATE TABLE `project` (
  ...
  `theme` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT 'A general thematic area of computing where the project falls under'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(94, 19, 'FitPal', 'Investigaten on firebase log in? What it is and what it does? Simmilar to what simon is doing with sheetjs. Explore the role of webpack in bundling code from different libraries', '', '', '9999-12-31', 'Firebase', 'Registrar (karanja) sheetjs'),
(95, 19, 'KKM', 'How to get data from whats app group whithout a third party. Document the mutall class for working with whats app messeges. Problems with exporting media (with captions)', '', '', '9999-12-31', 'Whats app', 'Migration (mogaka)\n-- Migration mapping data to attributes\n-- Muli to do a mapping chart.'),
(96, 19, 'Documentation database', 'Manage all the documentation we have. Have a method to count words and think of other improvements to the documentation system. Investigate on image hotspots to help in documentation of the user interfaces of our application.', '', '', '9999-12-31', 'karanja, muli', 'Documentation svg for solving relative positioning \n(Mogaka)'),
(97, 19, 'Image Processing', 'Upgrade and support  the mutall imegery dbase. Car number plate extraction. Python for extracting handwritten data form documents to support transcriptions', '', '', '9999-12-31', 'OCR/ Handwritting', 'Imagery'),
(98, 19, 'Mashamba', 'Publish current titles. Level 2 registration of mashamba users. Migration of the data from the previous data model to the new model. Do research on GIS to help in land disputes and identification of amenities near a parcel of land', '', '', '9999-12-31', 'Nelson presentation', 'Tabulation\n-Elias and Mogaka\n--Elias & Karen should learn how to construct and style html tables\n--Elias should know how to write a program that produces a html table\n--'),
...
(101, 20, 'Metavisuo', 'Work on CRUD for data and metadata. Design and write a user intreface documentation for the new version of metavisuo', '', '', '9999-12-31', 'CRUD', '-Metavisuo\n--Investigate why metavisuo is not working on the server\n---'),
(102, 20, 'Rentize', 'Get all the rental cte\'s and ensure they are completed and up to standard', '', '', '9999-12-31', 'CTE\'s', 'Rentize'),
(103, 20, 'Billing', 'Work on acquisition of electricity bills usint an Android platform(Contract for mutall)', '', '', '9999-12-31', 'KPLC/ Android', 'Rentize'),
...
(105, 20, 'Registration', 'Work on documentation and mainstreaming of the level 1 registration and also work on level 2 registartion for various projects am working on', '', '', '9999-12-31', 'Registrar/ Label / IO', 'Registration of interns'),
(106, 20, 'Tracker', 'Work on planning aspect. Also work on a presentation loading .Define a general template of workplan and populate it with data form the database', '', '', '9999-12-31', 'Academic', '-Improve the workplan module\n--Review the current model to ensure it can publish and accomodate this years workplans\n-Change column name to App\n-Add a button on planner to add a project'),
(107, 17, 'Balansys', 'Receipt and stock control project. Continue with bmj stock control. Enter data in the database and then to quickbooks', '', '', '9999-12-31', 'Recipt / Stock control', '-Migration\n--Load all the dirty/excel receipts\n--Prepare loader for individual receipts\n--Assist divan to link the receipt data to the images\n--link the images to the url on the folder\n--indirect export of large image database from client(pmuraya) to server dev.mutall.co.ke'),
(108, 17, 'Rentize', 'Client registration and query consolidation. In conjunction with anne\'s contract management system', '', '', '9999-12-31', 'Contracts  + Client registration', '-Registrar\n--Assist Ann to invoice the excel work\n--Assist Ann to install the entire system On Muraya\'s laptop\n--Merge database with template to reproduce the contracts\n--Capture details of missing contracts'),
(109, 17, 'Event planner', 'Learning linux and understanding how the server works', '', '', '9999-12-31', 'Linux / CRON', '-Cron\n-- Setting up a scheduler in windows\n-- Setting up a CRON  job on the server\n-- Learning Linux and understanding how the server works\n-Sockets \n-CORS\n--Installation of phpmyadmin in the server'),
(110, 17, 'Tracker', 'Managing the financial aspect of the internship e.g, tracking intern loans, Kitchen consumption, monthly stipends. This project will involve kibe with his documentation work and Mogaka who will help with development of the database', '', '', '9999-12-31', 'Accounting / Finance', '-Accountant\n--Load the journal entries for February'),
(111, 17, 'Cybercafe', 'Exploring how to communicate legitimately across origins. Mogaka and karanja to investigate communication headers with help from peter. ', '', '', '9999-12-31', 'CORS', '-CORS\n--Resarch on the appropriate headers that solve the CORS problem (mogaka and karanja)'),
...
(117, 17, 'Registration', 'Proceed to register users for the various applications', '', '', '9999-12-31', 'Registrar / Balansys', '-registration\n--Everybody to do a registration system relevant to their application'),
(118, 18, 'Mlima', 'Pick up the pieces of mlima website and make it work together. In mlima the objective should go on the left', '', '', '9999-12-31', 'Consolidate code / Hotspot documentation', 'Consolidation,the scrolling images of members\n-Regestration of members\n-Message app'),
(119, 18, 'Chat', 'Getting familiar with sockets.  A stand alone application for saving chats. Investigate on monaco editor. Investigate the posibility of using elixir for the sockets', '', '', '9999-12-31', 'Sockets / Elixir', '-Messenger\n--Inherit the chat system from Peter\n-wifi- limit number of users'),
(120, 18, 'Sheetjs', 'Working with sheet js library  on balansys. Load the last five list to the balansys database', '', '', '9999-12-31', 'Exam system', '-Migration\n--Explore the webpack tool for working with node modules\n---install webpack test it'),
(121, 18, 'Cyber security', 'Focus on security of data', '', '', '9999-12-31', 'X', NULL),
(122, 18, 'Registration', 'Proceed to register mlima members ( Level 2 registration). Previewing images, factuate , and upload images', '', '', '9999-12-31', 'Registrar / Mlima', '-Registrar\n--install and run the code for registering mlima members'),
(123, 21, 'Data views', 'Work on a module to tabulate data independent of the source. Use Shule, Oritech and Chama to further the agenda', '', '', '9999-12-31', 'Label format / Tabulation / Tree view', 'Explore zone, i.e. homozones etc');
...
--
ALTER TABLE `intern`
  MODIFY `intern` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
